            ...
            <div class="row">
                <div class="col-xl-6" data-select2-id="6">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" value="<?php echo e(old('name') ? old('name') : $product->name); ?>" name="name" class="form-control" placeholder="Enter product name">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="summernote-basic" rows="5" placeholder="Enter description about project.."><?php echo e(old('description') ? old('description') : $product->description); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantity" min="0" value="<?php echo e(old('quantity') ? old('quantity') : $product->quantity); ?>" name="quantity" class="form-control">
                        ...
                        <div class="form-check">
                            <?php $__currentLoopData = $listStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <input
                                    ...
                                    <?php echo e($loop->first || $product->status === $status ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="old_price" value="<?php echo e(old('old_price') ? old('old_price') : $product->old_price); ?>" name="old_price" class="form-control" step="any">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sale_price" value="<?php echo e(old('sale_price') ? old('sale_price') : $product->sale_price); ?>" name="sale_price" class="form-control" step="any">
                        ...
                        <select name="categories[]" class="form-control select2 select2-hidden-accessible" multiple data-toggle="select2" tabindex="-1" aria-hidden="true">
                            <?php $__currentLoopData = $listCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>"
                                    <?php echo e(in_array($category->id, old('categories', [])) || in_array($category->id, $product->categories->pluck('id')->toArray())  ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="uploaded_current_image_view show w-50">
                            <img src="<?php echo e($product->thumb); ?>" alt="current image">
                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>