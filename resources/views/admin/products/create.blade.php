            ...
            <div class="row">
                <div class="col-xl-6" data-select2-id="6">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" value="{{old('name')}}" name="name" class="form-control" placeholder="Enter product name">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="summernote-basic" rows="5" placeholder="Enter description about project..">{{old('description')}}</textarea>
                        @error('description')
                        <span id="name-error" class="error text-danger" style="display: block">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantity" min="0" value="{{old('quantity')}}" name="quantity" class="form-control">
                        @error('quantity')
                        <span id="name-error" class="error text-danger" style="display: block">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-xl-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="old_price" value="{{old('old_price')}}" name="old_price" class="form-control">
                        @error('old_price')
                        <span id="name-error" class="error text-danger" style="display: block">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sale_price" value="{{old('sale_price')}}" name="sale_price" class="form-control">
                        @error('sale_price')
                        <span id="name-error" class="error text-danger" style="display: block">{{$message}}</span>
                        @enderror
                    </div>
